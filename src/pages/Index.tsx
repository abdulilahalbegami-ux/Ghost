      ...
      <div className="flex flex-col h-full justify-between">
        <div className="space-y-6 flex-1 flex flex-col min-h-0">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-zinc-900 text-white hover:bg-zinc-800 dark:bg-white dark:text-black dark:hover:bg-white/90 rounded-xl text-xs font-bold uppercase tracking-wider transition-all shrink-0 shadow-[0_0_15px_rgba(0,0,0,0.1)] dark:shadow-[0_0_15px_rgba(255,255,255,0.1)]"
          >
                    ...
                    <div className="flex bg-zinc-100 dark:bg-black border border-zinc-200 dark:border-white/10 rounded-lg p-0.5">
                      {(["sm", "md", "lg"] as const).map((sz) => (
                        <button
                          ...
                          className={`px-2.5 py-1 rounded-md text-[10px] font-semibold uppercase tracking-wider transition-all ${
                            fontSize === sz ? "bg-zinc-900<dyad-write path="src/pages/Index.tsx" description="Completing the Index.tsx file with full theme support and responsive light/dark styling.">
"use client";
