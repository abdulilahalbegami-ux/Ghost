        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-white/10 rounded-2xl p-6 max-w-sm w-full space-y-4 relative">
            ...
            <div className="relative flex py-2 items-center">
              ...
              <span className="flex<dyad-write path="src/pages/Index.tsx" description="Completing the Index.tsx file cleanly to ensure perfect compilation and direct question answering.">
"use client";
